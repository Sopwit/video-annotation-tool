...
var Et = function(r12) {
  var e2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t3, i2, a3, n3, o4, s3 = r12 ? [console, r12] : [console], u4 = (t3 = console.trace).bind.apply(t3, W(s3)), p6 = (i2 = console.info).bind.apply(i2, W(s3)), b4 = (a3 = console.debug).bind.apply(a3, W(s3)), k3 = (n3 = console.warn).bind.apply(n3, W(s3)), y4 = (o4 = console.error).bind.apply(o4, W(s3)), c4 = e2;
...
var Ot = function(r12, e2, t3) {
  ...
  var u4 = function(m6, f6) {
    return r12.emit(e2, m6, f6);
  }, p6 = function(m6, f6) {
    var _3 = f6.levels, d5 = f6.audioTracks, h3 = f6.url, w3 = f6.stats, E5 = f6.networkDetails, S2 = f6.sessionData, N4 = {}, M4 = {};
    ...
    var P5 = Me(w3), R2 = P5.bytesLoaded, Z2 = P5.requestStart, Te3 = P5.responseStart, we3 = P5.responseEnd;
    u4("requestcompleted", fe(ue({}, Ce(S2)), { request_event_type: m6, request_bytes_loaded: R2, request_start: Z2, request_response_start: Te3, request_response_end: we3, request_type: "manifest", request_hostname: F(h3), request_response_headers: Se(E5), request_rendition_lists: { media: N4, audio: M4, video: {} } }));
  };
  t3.on(a3.Events.MANIFEST_LOADED, p6);
  var b4 = function(m6, f6) {
    var _3 = f6.details, d5 = f6.level, h3 = f6.networkDetails, w3 = f6.stats, E5 = Me(w3), S2 = E5.bytesLoaded, N4 = E5.requestStart, M4 = E5.responseStart, P5 = E5.responseEnd, R2 = _3.fragments[_3.fragments.length - 1], Z2 = s3(R2) + o4(R2.duration);
    u4("requestcompleted", { request_event_type: m6, request_bytes_loaded: S2, request_start: N4, request_response_start: M4, request_response_end: P5, request_current_level: d5, request_type: "manifest", request_hostname: F(_3.url), request_response_headers: Se(h3), video_holdback: _3.holdBack && o4(_3.holdBack), video_part_holdback: _3.partHoldBack && o4(_3.partHoldBack), video_part_target_duration: _3.partTarget && o4(_3.partTarget), video_target_duration: _3.targetduration && o4(_3.targetduration), video_source_is_live: _3.live, player_manifest_newest_program_time: isNaN(Z2) ? void 0 : Z2 });
  };
  t3.on(a3.Events.LEVEL_LOADED, b4);
  var k3 = function(m6, f6) {
    var _3 = f6.details, d5 = f6.networkDetails, h3 = f6.stats, w3 = Me(h3), E5 = w3.bytesLoaded, S2 = w3.requestStart, N4 = w3.responseStart, M4 = w3.responseEnd;
    u4("requestcompleted", { request_event_type: m6, request_bytes_loaded: E5, request_start: S2, request_response_start: N4, request_response_end: M4, request_type: "manifest", request_hostname: F(_3.url), request_response_headers: Se(d5) });
  };
  t3.on(a3.Events.AUDIO_TRACK_LOADED, k3);
  var y4 = function(m6, f6) {
    var _3 = f6.stats, d5 = f6.networkDetails, h3 = f6.frag;
    _3 = _3 || h3.stats;
    var w3 = Me(_3), E5 = w3.bytesLoaded, S2 = w3.requestStart, N4 = w3.responseStart, M4 = w3.responseEnd, P5 = d5 ? Se(d5) : void 0, R2 = { request_event_type: m6, request_bytes_loaded: E5, request_start: S2, request_response_start: N4, request_response_end: M4, request_hostname: d5 ? F(d5.responseURL) : void 0, request_id: P5 ? de(P5) : void 0, request_response_headers: P5, request_media_duration: h3.duration, request_url: d5 == null ? void 0 : d5.responseURL };
    h3.type === "main" ? (R2.request_type = "media", R2.request_current_level = h3.level, R2.request_video_width = (t3.levels[h3.level] || {}).width, R2.request_video_height = (t3.levels[h3.level] || {}).height, R2.request_labeled_bitrate = (t3.levels[h3.level] || {}).bitrate) : R2.request_type = h3.type, u4("requestcompleted", R2);
  };
  t3.on(a3.Events.FRAG_LOADED, y4);
  var c4 = function(m6, f6) {
    var _3 = f6.frag, d5 = _3.start, h3 = s3(_3), w3 = { currentFragmentPDT: h3, currentFragmentStart: o4(d5) };
    u4("fragmentchange", w3);
  };
  t3.on(a3.Events.FRAG_CHANGED, c4);
  var v4 = function(m6, f6) {
    var _3 = f6.type, d5 = f6.details, h3 = f6.response, w3 = f6.fatal, E5 = f6.frag, S2 = f6.networkDetails, N4 = (E5 == null ? void 0 : E5.url) || f6.url || "", M4 = S2 ? Se(S2) : void 0;
    if ((d5 === a3.ErrorDetails.MANIFEST_LOAD_ERROR || d5 === a3.ErrorDetails.MANIFEST_LOAD_TIMEOUT || d5 === a3.ErrorDetails.FRAG_LOAD_ERROR || d5 === a3.ErrorDetails.FRAG_LOAD_TIMEOUT || d5 === a3.ErrorDetails.LEVEL_LOAD_ERROR || d5 === a3.ErrorDetails.LEVEL_LOAD_TIMEOUT || d5 === a3.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || d5 === a3.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT || d5 === a3.ErrorDetails.SUBTITLE_LOAD_ERROR || d5 === a3.ErrorDetails.SUBTITLE_LOAD_TIMEOUT || d5 === a3.ErrorDetails.KEY_LOAD_ERROR || d5 === a3.ErrorDetails.KEY_LOAD_TIMEOUT) && u4("requestfailed", { request_error: d5, request_url: N4, request_hostname: F(N4), request_id: M4 ? de(M4) : void 0, request_type: d5 === a3.ErrorDetails.FRAG_LOAD_ERROR || d5 === a3.ErrorDetails.FRAG_LOAD_TIMEOUT ? "media" : d5 === a3.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || d5 === a3.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT ? "audio" : d5 === a3.ErrorDetails.SUBTITLE_LOAD_ERROR || d5 === a3.ErrorDetails.SUBTITLE_LOAD_TIMEOUT ? "subtitle" : d5 === a3.ErrorDetails.KEY_LOAD_ERROR || d5 === a3.ErrorDetails.KEY_LOAD_TIMEOUT ? "encryption" : "manifest", request_error_code: h3 == null ? void 0 : h3.code, request_error_text: h3 == null ? void 0 : h3.text }), w3) {
      var P5, R2 = "".concat(N4 ? "url: ".concat(N4, "\n") : "") + "".concat(h3 && (h3.code || h3.text) ? "response: ".concat(h3.code, ", ").concat(h3.text, "\n") : "") + "".concat(f6.reason ? "failure reason: ".concat(f6.reason, "\n") : "") + "".concat(f6.level ? "level: ".concat(f6.level, "\n") : "") + "".concat(f6.parent ? "parent stream controller: ".concat(f6.parent, "\n") : "") + "".concat(f6.buffer ? "buffer length: ".concat(f6.buffer, "\n") : "") + "".concat(f6.error ? "error: ".concat(f6.error, "\n") : "") + "".concat(f6.event ? "event: ".concat(f6.event, "\n") : "") + "".concat(f6.err ? "error message: ".concat((P5 = f6.err) === null || P5 === void 0 ? void 0 : P5.message, "\n") : "");
      u4("error", { player_error_code: _3, player_error_message: d5, player_error_context: R2 });
    }
  };
  t3.on(a3.Events.ERROR, v4);
  var T3 = function(m6, f6) {
    var _3 = f6.frag, d5 = _3 && _3._url || "";
  ...
  var x7 = function(m6, f6) {
    var _3 = f6.level, d5 = t3.levels[_3];
    if (d5 && d5.attrs && d5.attrs.BANDWIDTH) {
      var h3 = d5.attrs.BANDWIDTH, w3, E5 = parseFloat(d5.attrs["FRAME-RATE"]);
      isNaN(E5) || (w3 = E5), h3 ? u4("renditionchange", { video_source_fps: w3, video_source_bitrate: h3, video_source_width: d5.width, video_source_height: d5.height, video_source_rendition_name: d5.name, video_source_codec: d5 == null ? void 0 : d5.videoCodec }) : n3.warn("missing BANDWIDTH from HLS manifest parsed by HLS.js");
    }
  };
  t3.on(a3.Events.LEVEL_SWITCHED, x7), t3._stopMuxMonitor = function() {
    t3.off(a3.Events.MANIFEST_LOADED, p6), t3.off(a3.Events.LEVEL_LOADED, b4), t3.off(a3.Events.AUDIO_TRACK_LOADED, k3), t3.off(a3.Events.FRAG_LOADED, y4), t3.off(a3.Events.FRAG_CHANGED, c4), t3.off(a3.Events.ERROR, v4), t3.off(a3.Events.FRAG_LOAD_EMERGENCY_ABORTED, T3), t3.off(a3.Events.LEVEL_SWITCHED, x7), t3.off(a3.Events.DESTROYING, t3._stopMuxMonitor), delete t3._stopMuxMonitor;
...
var It = function(r12, e2) {
  ...
  var t3 = F(r12.url), i2 = r12.url, a3 = r12.bytesLoaded, n3 = new Date(r12.requestStartDate).getTime(), o4 = new Date(r12.firstByteDate).getTime(), s3 = new Date(r12.requestEndDate).getTime(), u4 = isNaN(r12.duration) ? 0 : r12.duration, p6 = typeof e2.getMetricsFor == "function" ? e2.getMetricsFor(r12.mediaType).HttpList : e2.getDashMetrics().getHttpRequests(r12.mediaType), b4;
  p6.length > 0 && (b4 = pe(p6[p6.length - 1]._responseHeaders || ""));
  var k3 = b4 ? de(b4) : void 0;
  return { requestStart: n3, requestResponseStart: o4, requestResponseEnd: s3, requestBytesLoaded: a3, requestResponseHeaders: b4, requestMediaDuration: u4, requestHostname: t3, requestUrl: i2, requestId: k3 };
};
...
var Nt = function(r12, e2, t3) {
  ...
  var n3 = la(t3), o4 = function(_3, d5) {
    return r12.emit(e2, _3, d5);
  }, s3 = function(_3) {
    var d5 = _3.type, h3 = _3.data, w3 = (h3 || {}).url;
  ...
  var u4 = {}, p6 = function(_3) {
    if (typeof _3.getRequests != "function") return null;
    var d5 = _3.getRequests({ state: "executed" });
    return d5.length === 0 ? null : d5[d5.length - 1];
  }, b4 = function(_3) {
    var d5 = _3.type, h3 = _3.fragmentModel, w3 = _3.chunk, E5 = p6(h3);
    k3({ type: d5, request: E5, chunk: w3 });
  }, k3 = function(_3) {
    var d5 = _3.type, h3 = _3.chunk, w3 = _3.request, E5 = (h3 || {}).mediaInfo, S2 = E5 || {}, N4 = S2.type, M4 = S2.bitrateList;
    M4 = M4 || [];
    var P5 = {};
    M4.forEach(function(Ee3, z3) {
      P5[z3] = {}, P5[z3].width = Ee3.width, P5[z3].height = Ee3.height, P5[z3].bitrate = Ee3.bandwidth, P5[z3].attrs = {};
    }), N4 === "video" ? u4.video = P5 : N4 === "audio" ? u4.audio = P5 : u4.media = P5;
    var R2 = It(w3, t3), Z2 = R2.requestStart, Te3 = R2.requestResponseStart, we3 = R2.requestResponseEnd, G3 = R2.requestResponseHeaders, oe4 = R2.requestMediaDuration, Ve2 = R2.requestHostname, We2 = R2.requestUrl, je2 = R2.requestId;
    o4("requestcompleted", { request_event_type: d5, request_start: Z2, request_response_start: Te3, request_response_end: we3, request_bytes_loaded: -1, request_type: N4 + "_init", request_response_headers: G3, request_hostname: Ve2, request_id: je2, request_url: We2, request_media_duration: oe4, request_rendition_lists: u4 });
  };
  n3 >= 4 ? t3.on("initFragmentLoaded", k3) : t3.on("initFragmentLoaded", b4);
  var y4 = function(_3) {
    var d5 = _3.type, h3 = _3.fragmentModel, w3 = _3.chunk, E5 = p6(h3);
    c4({ type: d5, request: E5, chunk: w3 });
  }, c4 = function(_3) {
    var d5 = _3.type, h3 = _3.chunk, w3 = _3.request, E5 = h3 || {}, S2 = E5.mediaInfo, N4 = E5.start, M4 = S2 || {}, P5 = M4.type, R2 = It(w3, t3), Z2 = R2.requestStart, Te3 = R2.requestResponseStart, we3 = R2.requestResponseEnd, G3 = R2.requestBytesLoaded, oe4 = R2.requestResponseHeaders, Ve2 = R2.requestMediaDuration, We2 = R2.requestHostname, je2 = R2.requestUrl, Ee3 = R2.requestId, z3 = ua(P5, t3), Jr = z3.currentLevel, Qr2 = z3.renditionWidth, zr2 = z3.renditionHeight, Kr = z3.renditionBitrate;
  ...
  var v4 = { video: void 0, audio: void 0, totalBitrate: void 0 }, T3 = function() {
    ...
    if (w3 === "audio" || w3 === "video") {
      var E5 = t3.getBitrateInfoListFor(w3).find(function(N4) {
        var M4 = N4.qualityIndex;
      ...
      v4[w3] = fe(ue({}, E5), { codec: t3.getCurrentTrackFor(w3).codec });
      var S2 = T3();
  ...
  var m6 = function(_3) {
    var d5 = _3.request, h3 = _3.mediaType;
    d5 = d5 || {}, o4("requestcanceled", { request_event_type: d5.type + "_" + d5.action, request_url: d5.url, request_type: h3, request_hostname: F(d5.url) });
  };
  t3.on("fragmentLoadingAbandoned", m6);
  var f6 = function(_3) {
    var d5 = _3.error, h3, w3, E5 = (d5 == null || (h3 = d5.data) === null || h3 === void 0 ? void 0 : h3.request) || {}, S2 = (d5 == null || (w3 = d5.data) === null || w3 === void 0 ? void 0 : w3.response) || {};
    (d5 == null ? void 0 : d5.code) === 27 && o4("requestfailed", { request_error: E5.type + "_" + E5.action, request_url: E5.url, request_hostname: F(E5.url), request_type: E5.mediaType, request_error_code: S2.status, request_error_text: S2.statusText });
    var N4 = "".concat(E5 != null && E5.url ? "url: ".concat(E5.url, "\n") : "") + "".concat(S2 != null && S2.status || S2 != null && S2.statusText ? "response: ".concat(S2 == null ? void 0 : S2.status, ", ").concat(S2 == null ? void 0 : S2.statusText, "\n") : "");
    o4("error", { player_error_code: d5 == null ? void 0 : d5.code, player_error_message: d5 == null ? void 0 : d5.message, player_error_context: N4 });
  };
...
var ca = (function() {
  ...
  return L(r12, [{ key: "on", value: function(t3, i2, a3) {
    ...
    if (this._listeners) {
      i2 = i2 || {};
      var n3 = this._listeners["before*"] || [], o4 = this._listeners[t3] || [], s3 = this._listeners["after" + t3] || [], u4 = function(p6, b4) {
    ...
    function i2(a3, n3, o4) {
      ...
      if (typeof document != "undefined") {
        ...
        for (var p6 = document.cookie ? document.cookie.split("; ") : [], b4 = /(%[0-9A-Z]{2})+/g, k3 = 0; k3 < p6.length; k3++) {
          ...
          try {
            var v4 = y4[0].replace(b4, decodeURIComponent);
...
$.prototype._createPayload = function(r12) {
  ...
  return o4(), s3() || (q.info("Payload size is too big (" + n3 + " kb). Removing unnecessary events."), a3 = r12.filter(function(u4) {
    ...
    for (var p6 in u4) {
      var b4 = u4[p6], k3 = 50 * 1024;
      typeof b4 == "string" && b4.length > k3 && (u4[p6] = b4.substring(0, k3));
    }
  }), o4()), i2;
};
...
var Hr = (function() {
  ...
  function r12(e2, t3) {
    ...
    D(this, r12);
    var a3, n3, o4, s3, u4, p6, b4, k3, y4, c4, v4, T3;
...
var fi = function r7(e2) {
  ...
  var t3 = 0, i2 = 0, a3 = 0, n3 = 0, o4 = 0, s3 = 0, u4 = 0, p6 = function(y4, c4) {
    ...
    if (T3 ? (f6 = T3 - (v4 != null ? v4 : 0), _3 = (x7 != null ? x7 : 0) - T3) : _3 = (x7 != null ? x7 : 0) - (v4 != null ? v4 : 0), _3 > 0 && m6 && m6 > 0) {
      var d5 = m6 / _3 * 8e3;
      o4++, i2 += m6, a3 += _3, e2.data.view_min_request_throughput = Math.min(e2.data.view_min_request_throughput || 1 / 0, d5), e2.data.view_average_request_throughput = i2 / a3 * 8e3, e2.data.view_request_count = n3, f6 > 0 && (t3 += f6, e2.data.view_max_request_latency = Math.max(e2.data.view_max_request_latency || 0, f6), e2.data.view_average_request_latency = t3 / o4);
    }
  }, b4 = function(y4, c4) {
...
var vi = function r8(e2) {
  ...
  D(this, r8), l(this, "_lastEventTime", void 0), e2.on("before*", function(i2, a3) {
    ...
    if (t3._lastEventTime = o4, s3 && o4 - s3 > pi) {
      var u4 = Object.keys(e2.data).reduce(function(b4, k3) {
...
function st(r12, e2, t3) {
  var i2 = H(se(e2), 3), a3 = i2[0], n3 = i2[1], o4 = i2[2], s3 = r12.log, u4 = r12.utils.getComputedStyle, p6 = r12.utils.secondsToMs, b4 = { automaticErrorTracking: true };
  if (a3) {
    ...
    if (a3.getStartDate && m6 > 0) {
      ...
      if (h3 && typeof h3.getTime == "function" && h3.getTime()) {
        ...
        if (d5.player_program_time = w3 + m6, a3.seekable.length > 0) {
          var E5 = w3 + a3.seekable.end(a3.seekable.length - 1);
          d5.player_live_edge_program_time = E5;
        }
      }
    }
    return d5;
...
function x(e2, t3 = true) {
  var o4, s3;
  let r12 = t3 && (s3 = (o4 = Y2) == null ? void 0 : o4[e2]) != null ? s3 : e2, n3 = t3 ? Y2.code : Me2;
  return new z(r12, n3);
}
var z = class {
...
var Re = (e2, t3, r12) => {
  let { autoplay: n3 } = e2, o4 = false, s3 = false, a3 = xe(n3) ? n3 : !!n3, i2 = () => {
    o4 || v(t3, "playing", () => {
      o4 = true;
    }, { once: true });
  };
  if (i2(), v(t3, "loadstart", () => {
    o4 = false, i2(), te2(t3, a3);
  }, { once: true }), v(t3, "loadstart", () => {
    r12 || (e2.streamType && e2.streamType !== _.UNKNOWN ? s3 = e2.streamType === _.LIVE : s3 = !Number.isFinite(t3.duration)), te2(t3, a3);
  }, { once: true }), r12 && r12.once(g2.Events.LEVEL_LOADED, (u4, c4) => {
    var d5;
    e2.streamType && e2.streamType !== _.UNKNOWN ? s3 = e2.streamType === _.LIVE : s3 = (d5 = c4.details.live) != null ? d5 : false;
  }), !a3) {
    let u4 = () => {
    ...
    r12 && v(t3, "play", () => {
      t3.preload === "metadata" ? r12.once(g2.Events.LEVEL_UPDATED, u4) : u4();
    }, { once: true });
  }
  return (u4) => {
    o4 || (a3 = xe(u4) ? u4 : !!u4, te2(t3, a3));
  };
};
var te2 = (e2, t3) => {
  if (!t3) return;
...
var be2 = ({ preload: e2, src: t3 }, r12, n3) => {
  let o4 = (d5) => {
    d5 != null && ["", "none", "metadata", "auto"].includes(d5) ? r12.setAttribute("preload", d5) : r12.removeAttribute("preload");
  };
  if (!n3) return o4(e2), o4;
  let s3 = false, a3 = false, i2 = n3.config.maxBufferLength, l3 = n3.config.maxBufferSize, u4 = (d5) => {
    o4(d5);
    let p6 = d5 != null ? d5 : r12.preload;
    a3 || p6 === "none" || (p6 === "metadata" ? (n3.config.maxBufferLength = 1, n3.config.maxBufferSize = 1) : (n3.config.maxBufferLength = i2, n3.config.maxBufferSize = l3), c4());
  }, c4 = () => {
    !s3 && t3 && (s3 = true, n3.loadSource(t3));
  };
  return v(r12, "play", () => {
    a3 = true, n3.config.maxBufferLength = i2, n3.config.maxBufferSize = l3, c4();
  }, { once: true }), u4(e2), u4;
};
function De2(e2, t3) {
  var i2;
  ...
  t3.on(g2.Events.MANIFEST_PARSED, function(l3, u4) {
    a3();
    let c4 = e2.addVideoTrack("main");
    c4.selected = true;
    for (let [d5, p6] of u4.levels.entries()) {
      let T3 = c4.addRendition(p6.url[0], p6.width, p6.height, p6.videoCodec, p6.bitrate);
      r12.set(p6, `${d5}`), T3.id = `${d5}`;
    }
  }), t3.on(g2.Events.AUDIO_TRACKS_UPDATED, function(l3, u4) {
    s3();
    for (let c4 of u4.audioTracks) {
      let d5 = c4.default ? "main" : "alternative", p6 = e2.addAudioTrack(d5, c4.name, c4.lang);
      p6.id = `${c4.id}`, c4.default && (p6.enabled = true);
    }
  }), e2.audioTracks.addEventListener("change", () => {
    var c4;
    let l3 = +((c4 = [...e2.audioTracks].find((d5) => d5.enabled)) == null ? void 0 : c4.id), u4 = t3.audioTracks.map((d5) => d5.id);
    l3 != t3.audioTrack && u4.includes(l3) && (t3.audioTrack = l3);
  }), t3.on(g2.Events.LEVELS_UPDATED, function(l3, u4) {
    var p6;
    let c4 = e2.videoTracks[(p6 = e2.videoTracks.selectedIndex) != null ? p6 : 0];
    if (!c4) return;
    let d5 = u4.levels.map((T3) => r12.get(T3));
    for (let T3 of e2.videoRenditions) T3.id && !d5.includes(T3.id) && c4.removeRendition(T3);
  });
  let n3 = (l3) => {
    let u4 = l3.target.selectedIndex;
    u4 != t3.nextLevel && (t3.nextLevel = u4);
  };
  (i2 = e2.videoRenditions) == null || i2.addEventListener("change", n3);
  let o4 = () => {
    for (let l3 of e2.videoTracks) e2.removeVideoTrack(l3);
  }, s3 = () => {
    for (let l3 of e2.audioTracks) e2.removeAudioTrack(l3);
  }, a3 = () => {
    o4(), s3();
  };
  t3.once(g2.Events.DESTROYING, a3);
}
var re2 = (e2) => "time" in e2 ? e2.time : e2.startTime;
function Ce2(e2, t3) {
  t3.on(g2.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o4, { tracks: s3 }) => {
    s3.forEach((a3) => {
      var c4, d5;
      let i2 = (c4 = a3.subtitleTrack) != null ? c4 : a3.closedCaptions, l3 = t3.subtitleTracks.findIndex(({ lang: p6, name: T3, type: m6 }) => p6 == (i2 == null ? void 0 : i2.lang) && T3 === a3.label && m6.toLowerCase() === a3.kind), u4 = ((d5 = a3._id) != null ? d5 : a3.default) ? "default" : `${a3.kind}${l3}`;
      ne2(e2, a3.kind, a3.label, i2 == null ? void 0 : i2.lang, u4, a3.default);
    });
  });
  let r12 = () => {
    ...
    if (t3.subtitleTrack < 0 || (o4 == null ? void 0 : o4.id) !== a3) {
      let i2 = t3.subtitleTracks.findIndex(({ lang: l3, name: u4, type: c4, default: d5 }) => o4.id === "default" && d5 || l3 == o4.language && u4 === o4.label && c4.toLowerCase() === o4.kind);
      t3.subtitleTrack = i2;
    }
  ...
  e2.textTracks.addEventListener("change", r12), t3.on(g2.Events.CUES_PARSED, (o4, { track: s3, cues: a3 }) => {
    let i2 = e2.textTracks.getTrackById(s3);
    if (!i2) return;
    let l3 = i2.mode === "disabled";
    l3 && (i2.mode = "hidden"), a3.forEach((u4) => {
      var c4;
      (c4 = i2.cues) != null && c4.getCueById(u4.id) || i2.addCue(u4);
    }), l3 && (i2.mode = "disabled");
    ...
    Array.from(e2.textTracks).forEach((o4) => {
      ...
      if (!["subtitles", "caption"].includes(o4.kind) && (o4.label === "thumbnails" || o4.kind === "chapters")) {
        if (!((s3 = o4.cues) != null && s3.length)) {
          ...
          let l3 = e2.querySelector(i2), u4 = (a3 = l3 == null ? void 0 : l3.getAttribute("src")) != null ? a3 : "";
          l3 == null || l3.removeAttribute("src"), setTimeout(() => {
            l3 == null || l3.setAttribute("src", u4);
          }, 0);
        }
...
function ne2(e2, t3, r12, n3, o4, s3) {
...
async function ve2(e2, t3, r12, n3) {
  let o4 = w(e2, r12, n3);
  return o4 || (o4 = ne2(e2, n3, r12), o4.mode = "hidden", await new Promise((s3) => setTimeout(() => s3(void 0), 0))), o4.mode !== "hidden" && (o4.mode = "hidden"), [...t3].sort((s3, a3) => re2(a3) - re2(s3)).forEach((s3) => {
    var l3, u4;
    let a3 = s3.value, i2 = re2(s3);
    if ("endTime" in s3 && s3.endTime != null) o4 == null || o4.addCue(new VTTCue(i2, s3.endTime, n3 === "chapters" ? a3 : JSON.stringify(a3 != null ? a3 : null)));
      ...
      let c4 = Array.prototype.findIndex.call(o4 == null ? void 0 : o4.cues, (m6) => m6.startTime >= i2), d5 = (l3 = o4 == null ? void 0 : o4.cues) == null ? void 0 : l3[c4], p6 = d5 ? d5.startTime : Number.isFinite(e2.duration) ? e2.duration : Number.MAX_SAFE_INTEGER, T3 = (u4 = o4 == null ? void 0 : o4.cues) == null ? void 0 : u4[c4 - 1];
      T3 && (T3.endTime = i2), o4 == null || o4.addCue(new VTTCue(i2, p6, n3 === "chapters" ? a3 : JSON.stringify(a3 != null ? a3 : null)));
    }
...
function ke2(e2, t3 = { label: oe }) {
  ...
  let { currentTime: n3 } = e2, o4 = Array.prototype.find.call((a3 = r12.activeCues) != null ? a3 : [], ({ startTime: i2, endTime: l3 }) => i2 <= n3 && l3 > n3);
...
var Et2 = (e2, t3) => {
  ...
  return (o4 = t3.tokens) != null && o4[r12] ? (s3 = t3.tokens) == null ? void 0 : s3[r12] : O2(n3, t3) ? t3[n3] : void 0;
};
var H2 = (e2, t3, r12, n3, o4 = false, s3 = !((a3) => (a3 = globalThis.navigator) == null ? void 0 : a3.onLine)()) => {
  var M4, h3;
  if (s3) {
    let b4 = x("Your device appears to be offline", o4), E5 = void 0, y4 = f.MEDIA_ERR_NETWORK, k3 = new f(b4, y4, false, E5);
    return k3.errorCategory = t3, k3.muxCode = D2.NETWORK_OFFLINE, k3.data = e2, k3;
  }
  let i2 = "status" in e2 ? e2.status : e2.code, l3 = Date.now(), u4 = f.MEDIA_ERR_NETWORK;
  if (i2 === 200) return;
  let c4 = V2(t3), d5 = Et2(t3, r12), p6 = mt2(t3), [T3] = F2((M4 = r12.playbackId) != null ? M4 : "");
  if (!i2 || !T3) return;
  let m6 = ee2(d5);
  if (d5 && !m6) {
    let b4 = x("The {tokenNamePrefix}-token provided is invalid or malformed.", o4).format({ tokenNamePrefix: c4 }), E5 = x("Compact JWT string: {token}", o4).format({ token: d5 }), y4 = new f(b4, u4, true, E5);
    return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_TOKEN_MALFORMED, y4.data = e2, y4;
  }
  if (i2 >= 500) {
    let b4 = new f("", u4, n3 != null ? n3 : true);
    return b4.errorCategory = t3, b4.muxCode = D2.NETWORK_UNKNOWN_ERROR, b4;
  }
  if (i2 === 403) if (m6) {
    if (ye2(m6, l3)) {
      let b4 = { timeStyle: "medium", dateStyle: "medium" }, E5 = x("The video’s secured {tokenNamePrefix}-token has expired.", o4).format({ tokenNamePrefix: c4 }), y4 = x("Expired at: {expiredDate}. Current time: {currentDate}.", o4).format({ expiredDate: new Intl.DateTimeFormat("en", b4).format((h3 = m6.exp) != null ? h3 : 0 * 1e3), currentDate: new Intl.DateTimeFormat("en", b4).format(l3) }), k3 = new f(E5, u4, true, y4);
      return k3.errorCategory = t3, k3.muxCode = D2.NETWORK_TOKEN_EXPIRED, k3.data = e2, k3;
    }
    if (me(m6, T3)) {
      let b4 = x("The video’s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", o4).format({ tokenNamePrefix: c4 }), E5 = x("Specified playback ID: {playbackId} and the playback ID encoded in the {tokenNamePrefix}-token: {tokenPlaybackId}", o4).format({ tokenNamePrefix: c4, playbackId: T3, tokenPlaybackId: m6.sub }), y4 = new f(b4, u4, true, E5);
      return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_TOKEN_SUB_MISMATCH, y4.data = e2, y4;
    }
    if (Ee(m6, p6)) {
      let b4 = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o4).format({ tokenNamePrefix: c4 }), E5 = x("The {tokenNamePrefix}-token has no aud value. aud value should be {expectedAud}.", o4).format({ tokenNamePrefix: c4, expectedAud: p6 }), y4 = new f(b4, u4, true, E5);
      return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_TOKEN_AUD_MISSING, y4.data = e2, y4;
    }
    if (ge2(m6, p6)) {
      let b4 = x("The {tokenNamePrefix}-token is formatted with incorrect information.", o4).format({ tokenNamePrefix: c4 }), E5 = x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.", o4).format({ tokenNamePrefix: c4, expectedAud: p6, aud: m6.aud }), y4 = new f(b4, u4, true, E5);
      return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_TOKEN_AUD_MISMATCH, y4.data = e2, y4;
    }
  } else {
    let b4 = x("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", o4).format({ tokenNamePrefix: c4, category: t3 }), E5 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y4 = new f(b4, u4, n3 != null ? n3 : true, E5);
    return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_TOKEN_MISSING, y4.data = e2, y4;
  }
  if (i2 === 412) {
    let b4 = x("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", o4), E5 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y4 = new f(b4, u4, n3 != null ? n3 : true, E5);
    return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_NOT_READY, y4.streamType = r12.streamType === _.LIVE ? "live" : r12.streamType === _.ON_DEMAND ? "on-demand" : "unknown", y4.data = e2, y4;
  }
  if (i2 === 404) {
    let b4 = x("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", o4), E5 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y4 = new f(b4, u4, n3 != null ? n3 : true, E5);
    return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_NOT_FOUND, y4.data = e2, y4;
  }
  if (i2 === 400) {
    let b4 = x("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), E5 = x("Specified playback ID: {playbackId}", o4).format({ playbackId: T3 }), y4 = new f(b4, u4, n3 != null ? n3 : true, E5);
    return y4.errorCategory = t3, y4.muxCode = D2.NETWORK_INVALID_URL, y4.data = e2, y4;
  }
  let R2 = new f("", u4, n3 != null ? n3 : true);
  return R2.errorCategory = t3, R2.muxCode = D2.NETWORK_UNKNOWN_ERROR, R2.data = e2, R2;
};
...
var j = class j2 extends Se2 {
  ...
  getMaxLevel(t3) {
    ...
    let o4 = Math.min(n3[r12].width, n3[r12].height), s3 = j2.minMaxResolution;
    return o4 >= s3 ? r12 : Se2.getMaxLevelByMediaSize(n3, s3 * (16 / 9), s3);
  }
};
...
var Dt2 = (e2) => {
  var i2, l3, u4;
  let t3 = e2.split(`
`), n3 = (l3 = ((i2 = t3.find((c4) => c4.startsWith("#EXT-X-PLAYLIST-TYPE"))) != null ? i2 : "").split(":")[1]) == null ? void 0 : l3.trim(), o4 = Q2(n3), s3 = Z(n3), a3;
  if (o4 === _.LIVE) {
    let c4 = t3.find((p6) => p6.startsWith("#EXT-X-PART-INF"));
    if (!!c4) a3 = +c4.split(":")[1].split("=")[1] * 2;
    else {
      let p6 = t3.find((R2) => R2.startsWith("#EXT-X-TARGETDURATION")), T3 = (u4 = p6 == null ? void 0 : p6.split(":")) == null ? void 0 : u4[1];
      a3 = +(T3 != null ? T3 : 6) * 3;
    }
  }
...
var vt2 = async (e2, t3, r12 = U2({ src: e2 })) => {
  ...
  (i2 != null && i2.URI || i2 != null && i2.VALUE.toLocaleLowerCase().startsWith("http")) && de2((l3 = i2.URI) != null ? l3 : i2.VALUE, t3), ((u4 = P.get(t3)) != null ? u4 : {}).liveEdgeStartOffset = s3, ((c4 = P.get(t3)) != null ? c4 : {}).targetLiveWindow = o4, t3.dispatchEvent(new CustomEvent("targetlivewindowchange", { composed: true, bubbles: true })), ((d5 = P.get(t3)) != null ? d5 : {}).streamType = n3, t3.dispatchEvent(new CustomEvent("streamtypechange", { composed: true, bubbles: true }));
};
var de2 = async (e2, t3) => {
  var r12, n3;
  try {
    ...
    for (let l3 of s3[0].metadata) l3.key && l3.value && (a3[l3.key] = l3.value);
...
var Pt2 = (e2) => {
  var a3;
  let t3 = e2.type, r12 = Q2(t3), n3 = Z(t3), o4, s3 = !!((a3 = e2.partList) != null && a3.length);
  return r12 === _.LIVE && (o4 = s3 ? e2.partTarget * 2 : e2.targetduration * 3), { streamType: r12, targetLiveWindow: n3, liveEdgeStartOffset: o4, lowLatency: s3 };
};
var _t2 = (e2, t3, r12) => {
  var i2, l3, u4, c4, d5, p6, T3, m6;
  let { streamType: n3, targetLiveWindow: o4, liveEdgeStartOffset: s3, lowLatency: a3 } = Pt2(e2);
  if (n3 === _.LIVE) {
    a3 ? (r12.config.backBufferLength = (i2 = r12.userConfig.backBufferLength) != null ? i2 : 4, r12.config.maxFragLookUpTolerance = (l3 = r12.userConfig.maxFragLookUpTolerance) != null ? l3 : 1e-3, r12.config.abrBandWidthUpFactor = (u4 = r12.userConfig.abrBandWidthUpFactor) != null ? u4 : r12.config.abrBandWidthFactor) : r12.config.backBufferLength = (c4 = r12.userConfig.backBufferLength) != null ? c4 : 8;
    ...
    ((d5 = P.get(t3)) != null ? d5 : {}).seekable = R2;
  }
  ((p6 = P.get(t3)) != null ? p6 : {}).liveEdgeStartOffset = s3, ((T3 = P.get(t3)) != null ? T3 : {}).targetLiveWindow = o4, t3.dispatchEvent(new CustomEvent("targetlivewindowchange", { composed: true, bubbles: true })), ((m6 = P.get(t3)) != null ? m6 : {}).streamType = n3, t3.dispatchEvent(new CustomEvent("streamtypechange", { composed: true, bubbles: true }));
};
var He2;
var Ve;
...
var qr = ({ playbackId: e2, customDomain: t3 = A2, maxResolution: r12, minResolution: n3, renditionOrder: o4, programStartTime: s3, programEndTime: a3, assetStartTime: i2, assetEndTime: l3, playbackToken: u4, tokens: { playback: c4 = u4 } = {}, extraSourceParams: d5 = {} } = {}) => {
  if (!e2) return;
  let [p6, T3 = ""] = F2(e2), m6 = new URL(`https://stream.${t3}/${p6}.m3u8${T3}`);
  return c4 || m6.searchParams.has("token") ? (m6.searchParams.forEach((R2, M4) => {
    M4 != "token" && m6.searchParams.delete(M4);
  }), c4 && m6.searchParams.set("token", c4)) : (r12 && m6.searchParams.set("max_resolution", r12), n3 && (m6.searchParams.set("min_resolution", n3), r12 && +r12.slice(0, -1) < +n3.slice(0, -1) && console.error("minResolution must be <= maxResolution", "minResolution", n3, "maxResolution", r12)), o4 && m6.searchParams.set("rendition_order", o4), s3 && m6.searchParams.set("program_start_time", `${s3}`), a3 && m6.searchParams.set("program_end_time", `${a3}`), i2 && m6.searchParams.set("asset_start_time", `${i2}`), l3 && m6.searchParams.set("asset_end_time", `${l3}`), Object.entries(d5).forEach(([R2, M4]) => {
    M4 != null && m6.searchParams.set(R2, M4);
  })), m6.toString();
};
var q2 = (e2) => {
  if (!e2) return;
...
var Qe2 = (e2, t3) => {
  ...
  let r12 = t3.currentLevel >= 0 ? (c4 = (u4 = t3.levels) == null ? void 0 : u4[t3.currentLevel]) == null ? void 0 : c4.details : (d5 = t3.levels.find((p6) => !!p6.details)) == null ? void 0 : d5.details;
...
var Zr2 = (e2, t3, r12) => {
  Kt2(t3, r12, e2);
  let { metadata: n3 = {} } = e2, { view_session_id: o4 = St2() } = n3, s3 = wt2(e2);
  n3.view_session_id = o4, n3.video_id = s3, e2.metadata = n3;
  let a3 = (c4) => {
    var d5;
    (d5 = t3.mux) == null || d5.emit("hb", { view_drm_type: c4 });
  };
  e2.drmTypeCb = a3, P.set(t3, { retryCount: 0 });
  let i2 = Wt2(e2, t3), l3 = be2(e2, t3, i2);
  e2 != null && e2.muxDataKeepSession && (t3 != null && t3.mux) && !t3.mux.deleted ? i2 && t3.mux.addHLSJS({ hlsjs: i2, Hls: i2 ? g2 : void 0 }) : Jt2(e2, t3, i2), Gt2(e2, t3, i2), he2(t3), Ae2(t3);
  let u4 = Re(e2, t3, i2);
  return { engine: i2, setAutoplay: u4, setPreload: l3 };
};
var Kt2 = (e2, t3, r12) => {
...
function Ze2(e2, t3) {
  ...
  let o4 = !r12 || ((u4 = t3.canPlayType(r12)) != null ? u4 : true), { preferPlayback: s3 } = e2, a3 = s3 === X2.MSE, i2 = s3 === X2.NATIVE, l3 = Ge2 && (a3 || At2(t3));
  return o4 && (i2 || !l3);
}
var Wt2 = (e2, t3) => {
  let { debug: r12, streamType: n3, startTime: o4 = -1, metadata: s3, preferCmcd: a3, _hlsConfig: i2 = {} } = e2, u4 = U2(e2) === I.M3U8, c4 = Ze2(e2, t3);
  if (u4 && !c4 && Ge2) {
    let d5 = { backBufferLength: 30, renderTextTracksNatively: false, liveDurationInfinity: true, capLevelToPlayerSize: true, capLevelOnFPSDrop: true }, p6 = Yt2(n3), T3 = Ft2(e2), m6 = [S.QUERY, S.HEADER].includes(a3) ? { useHeaders: a3 === S.HEADER, sessionId: s3 == null ? void 0 : s3.view_session_id, contentId: s3 == null ? void 0 : s3.video_id } : void 0, R2 = i2.capLevelToPlayerSize == null ? { capLevelController: we } : {}, M4 = new g2({ debug: r12, startPosition: o4, cmcd: m6, xhrSetup: (h3, b4) => {
      var k3, pe3;
      if (a3 && a3 !== S.QUERY) return;
      let E5 = new URL(b4);
      if (!E5.searchParams.has("CMCD")) return;
      let y4 = ((pe3 = (k3 = E5.searchParams.get("CMCD")) == null ? void 0 : k3.split(",")) != null ? pe3 : []).filter((fe4) => fe4.startsWith("sid") || fe4.startsWith("cid")).join(",");
      E5.searchParams.set("CMCD", y4), h3.open("GET", E5);
    }, ...R2, ...d5, ...p6, ...T3, ...i2 });
    return M4.on(g2.Events.MANIFEST_PARSED, async function(h3, b4) {
      var y4, k3;
      let E5 = (y4 = b4.sessionData) == null ? void 0 : y4["com.apple.hls.chapters"];
      (E5 != null && E5.URI || E5 != null && E5.VALUE.toLocaleLowerCase().startsWith("http")) && de2((k3 = E5 == null ? void 0 : E5.URI) != null ? k3 : E5 == null ? void 0 : E5.VALUE, t3);
    }), M4;
  }
};
...
var Ft2 = (e2) => {
  ...
  return !t3 || !o4 ? {} : { emeEnabled: true, drmSystems: { "com.apple.fps": { licenseUrl: G(e2, "fairplay"), serverCertificateUrl: et(e2, "fairplay") }, "com.widevine.alpha": { licenseUrl: G(e2, "widevine") }, "com.microsoft.playready": { licenseUrl: G(e2, "playready") } }, requestMediaKeySystemAccessFunc: (s3, a3) => (s3 === "com.widevine.alpha" && (a3 = [...a3.map((i2) => {
    var u4;
    let l3 = (u4 = i2.videoCapabilities) == null ? void 0 : u4.map((c4) => ({ ...c4, robustness: "HW_SECURE_ALL" }));
    return { ...i2, videoCapabilities: l3 };
  }), ...a3]), navigator.requestMediaKeySystemAccess(s3, a3).then((i2) => {
    let l3 = gt2(s3);
    return n3 == null || n3(l3), i2;
  })) };
};
var $t2 = async (e2) => {
...
var jt2 = (e2, t3) => {
  v(t3, "encrypted", async (n3) => {
    try {
      ...
      if (!t3.mediaKeys) {
        let u4 = await navigator.requestMediaKeySystemAccess("com.apple.fps", [{ initDataTypes: [o4], videoCapabilities: [{ contentType: "application/vnd.apple.mpegurl", robustness: "" }], distinctiveIdentifier: "not-allowed", persistentState: "not-allowed", sessionTypes: ["temporary"] }]).then((d5) => {
          var p6;
          return (p6 = e2.drmTypeCb) == null || p6.call(e2, J2.FAIRPLAY), d5;
        }).catch(() => {
          let d5 = x("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), p6 = new f(d5, f.MEDIA_ERR_ENCRYPTED, true);
          p6.errorCategory = C2.DRM, p6.muxCode = D2.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, N(t3, p6);
        });
        if (!u4) return;
        let c4 = await u4.createMediaKeys();
        try {
          let d5 = await $t2(et(e2, "fairplay")).catch((p6) => {
            if (p6 instanceof Response) {
              let T3 = H2(p6, C2.DRM, e2);
          ...
          await c4.setServerCertificate(d5).catch(() => {
            let p6 = x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), T3 = new f(p6, f.MEDIA_ERR_ENCRYPTED, true);
      ...
      let a3 = t3.mediaKeys.createSession();
      a3.addEventListener("keystatuseschange", () => {
        a3.keyStatuses.forEach((u4) => {
          let c4;
          if (u4 === "internal-error") {
            let d5 = x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
            c4 = new f(d5, f.MEDIA_ERR_ENCRYPTED, true), c4.errorCategory = C2.DRM, c4.muxCode = D2.ENCRYPTED_CDM_ERROR;
          } else if (u4 === "output-restricted" || u4 === "output-downscaled") {
            let d5 = x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
            c4 = new f(d5, f.MEDIA_ERR_ENCRYPTED, false), c4.errorCategory = C2.DRM, c4.muxCode = D2.ENCRYPTED_OUTPUT_RESTRICTED;
          }
          c4 && N(t3, c4);
        });
      });
      let i2 = await Promise.all([a3.generateRequest(o4, s3).catch(() => {
        let u4 = x("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), c4 = new f(u4, f.MEDIA_ERR_ENCRYPTED, true);
        c4.errorCategory = C2.DRM, c4.muxCode = D2.ENCRYPTED_GENERATE_REQUEST_FAILED, N(t3, c4);
      }), new Promise((u4) => {
        a3.addEventListener("message", (c4) => {
          u4(c4.message);
        }, { once: true });
      })]).then(([, u4]) => u4), l3 = await Bt2(i2, G(e2, "fairplay")).catch((u4) => {
        if (u4 instanceof Response) {
          let c4 = H2(u4, C2.DRM, e2);
          return console.error("mediaError", c4 == null ? void 0 : c4.message, c4 == null ? void 0 : c4.context), c4 ? Promise.reject(c4) : Promise.reject(new Error("Unexpected error in license key request"));
        }
        return Promise.reject(u4);
      });
      await a3.update(l3).catch(() => {
        let u4 = x("Failed to update DRM license. This may be an issue with the player or your protected content."), c4 = new f(u4, f.MEDIA_ERR_ENCRYPTED, true);
        return c4.errorCategory = C2.DRM, c4.muxCode = D2.ENCRYPTED_UPDATE_LICENSE_FAILED, Promise.reject(c4);
      });
    } catch (o4) {
      N(t3, o4);
      return;
...
var Jt2 = (e2, t3, r12) => {
  var l3;
  let { envKey: n3, disableTracking: o4, muxDataSDK: s3 = Ed, muxDataSDKOptions: a3 = {} } = e2, i2 = tt(e2);
  if (!o4 && (n3 || i2)) {
    let { playerInitTime: u4, playerSoftwareName: c4, playerSoftwareVersion: d5, beaconCollectionDomain: p6, debug: T3, disableCookies: m6 } = e2, R2 = { ...e2.metadata, video_title: ((l3 = e2 == null ? void 0 : e2.metadata) == null ? void 0 : l3.video_title) || void 0 }, M4 = (h3) => typeof h3.player_error_code == "string" ? false : typeof e2.errorTranslator == "function" ? e2.errorTranslator(h3) : h3;
    s3.monitor(t3, { debug: T3, beaconCollectionDomain: p6, hlsjs: r12, Hls: r12 ? g2 : void 0, automaticErrorTracking: false, errorTranslator: M4, disableCookies: m6, ...a3, data: { ...n3 ? { env_key: n3 } : {}, player_software_name: c4, player_software: c4, player_software_version: d5, player_init_time: u4, ...R2 } });
  }
};
var Gt2 = (e2, t3, r12) => {
  var c4, d5;
  let n3 = Ze2(e2, t3), { src: o4, customDomain: s3 = A2 } = e2, a3 = () => {
    ...
    let p6 = Xe2(t3), T3, m6;
    p6.length > 0 && (T3 = p6.start(0), m6 = p6.end(0)), (l3 !== m6 || i2 !== T3) && t3.dispatchEvent(new CustomEvent("seekablechange", { composed: true })), i2 = T3, l3 = m6;
  };
  if (v(t3, "durationchange", u4), t3 && n3) {
    let p6 = U2(e2);
    if (typeof o4 == "string") {
      if (o4.endsWith(".mp4") && o4.includes(s3)) {
        let R2 = qe(o4), M4 = new URL(`https://stream.${s3}/${R2}/metadata.json`);
        de2(M4.toString(), t3);
      }
      let T3 = () => {
        if (Ue2(t3) !== _.LIVE || Number.isFinite(t3.duration)) return;
        let R2 = setInterval(u4, 1e3);
        t3.addEventListener("teardown", () => {
          clearInterval(R2);
        }, { once: true }), v(t3, "durationchange", () => {
          Number.isFinite(t3.duration) && clearInterval(R2);
        });
      }, m6 = async () => vt2(o4, t3, p6).then(T3).catch((R2) => {
        if (R2 instanceof Response) {
          let M4 = H2(R2, C2.VIDEO, e2);
          if (M4) {
            N(t3, M4);
            return;
          }
      ...
      if (t3.preload === "none") {
        ...
        v(t3, "play", R2, { once: true }), v(t3, "loadedmetadata", M4, { once: true });
      } else m6();
      (c4 = e2.tokens) != null && c4.drm ? jt2(e2, t3) : v(t3, "encrypted", () => {
        let R2 = x("Attempting to play DRM-protected content without providing a DRM token."), M4 = new f(R2, f.MEDIA_ERR_ENCRYPTED, true);
        M4.errorCategory = C2.DRM, M4.muxCode = D2.ENCRYPTED_MISSING_TOKEN, N(t3, M4);
      }, { once: true }), t3.setAttribute("src", o4), e2.startTime && (((d5 = P.get(t3)) != null ? d5 : {}).startTime = e2.startTime, t3.addEventListener("durationchange", rt2, { once: true }));
  ...
  } else r12 && o4 ? (r12.once(g2.Events.LEVEL_LOADED, (p6, T3) => {
    _t2(T3.details, t3, r12), u4(), Ue2(t3) === _.LIVE && !Number.isFinite(t3.duration) && (r12.on(g2.Events.LEVEL_UPDATED, u4), v(t3, "durationchange", () => {
      Number.isFinite(t3.duration) && r12.off(g2.Events.LEVELS_UPDATED, u4);
    }));
  }), r12.on(g2.Events.ERROR, (p6, T3) => {
    var R2, M4;
    let m6 = qt2(T3, e2);
    if (m6.muxCode === D2.NETWORK_NOT_READY) {
      let b4 = (R2 = P.get(t3)) != null ? R2 : {}, E5 = (M4 = b4.retryCount) != null ? M4 : 0;
      if (E5 < 6) {
        let y4 = E5 === 0 ? 5e3 : 6e4, k3 = new f(`Retrying in ${y4 / 1e3} seconds...`, m6.code, m6.fatal);
        Object.assign(k3, m6), N(t3, k3), setTimeout(() => {
          b4.retryCount = E5 + 1, T3.details === "manifestLoadError" && T3.url && r12.loadSource(T3.url);
        }, y4);
        return;
      } else {
        b4.retryCount = 0;
        let y4 = new f('Try again later or <a href="#" onclick="window.location.reload(); return false;" style="color: #4a90e2;">click here to retry</a>', m6.code, m6.fatal);
        Object.assign(y4, m6), N(t3, y4);
        return;
      }
    }
    N(t3, m6);
    ...
    let p6 = P.get(t3);
    p6 && p6.error && (p6.error = null, p6.retryCount = 0, t3.dispatchEvent(new Event("emptied")), t3.dispatchEvent(new Event("loadstart")));
  }), t3.addEventListener("error", ce2), v(t3, "waiting", a3), De2(e2, r12), Ce2(t3, r12), r12.attachMedia(t3)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt2(e2) {
  var n3;
...
async function nt2(e2) {
  ...
  if (t3.src && n3 === f.MEDIA_ERR_SRC_NOT_SUPPORTED && t3.readyState === HTMLMediaElement.HAVE_NOTHING) {
    setTimeout(() => {
      var a3;
      let s3 = (a3 = Ot2(t3)) != null ? a3 : t3.error;
      (s3 == null ? void 0 : s3.code) === f.MEDIA_ERR_SRC_NOT_SUPPORTED && N(t3, o4);
    }, 500);
    return;
  }
...
var qt2 = (e2, t3) => {
  ...
  let n3 = { [g2.ErrorTypes.NETWORK_ERROR]: f.MEDIA_ERR_NETWORK, [g2.ErrorTypes.MEDIA_ERROR]: f.MEDIA_ERR_DECODE, [g2.ErrorTypes.KEY_SYSTEM_ERROR]: f.MEDIA_ERR_ENCRYPTED }, o4 = (d5) => [g2.ErrorDetails.KEY_SYSTEM_LICENSE_REQUEST_FAILED, g2.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_REQUEST_FAILED].includes(d5.details) ? f.MEDIA_ERR_NETWORK : n3[d5.type], s3 = (d5) => {
    if (d5.type === g2.ErrorTypes.KEY_SYSTEM_ERROR) return C2.DRM;
    if (d5.type === g2.ErrorTypes.NETWORK_ERROR) return C2.VIDEO;
  }, a3, i2 = o4(e2);
  if (i2 === f.MEDIA_ERR_NETWORK && e2.response) {
    let d5 = (l3 = s3(e2)) != null ? l3 : C2.VIDEO;
    a3 = (u4 = H2(e2.response, d5, t3, e2.fatal)) != null ? u4 : new f("", i2, e2.fatal);
  } else if (i2 === f.MEDIA_ERR_ENCRYPTED) if (e2.details === g2.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) {
    let d5 = x("Attempting to play DRM-protected content without providing a DRM token.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_MISSING_TOKEN;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_NO_ACCESS) {
    let d5 = x("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_NO_SESSION) {
    let d5 = x("Failed to generate a DRM license request. This may be an issue with the player or your protected content.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, true), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_GENERATE_REQUEST_FAILED;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED) {
    let d5 = x("Failed to update DRM license. This may be an issue with the player or your protected content.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_UPDATE_LICENSE_FAILED;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED) {
    let d5 = x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR) {
    let d5 = x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, e2.fatal), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_CDM_ERROR;
  } else if (e2.details === g2.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED) {
    let d5 = x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
    a3 = new f(d5, f.MEDIA_ERR_ENCRYPTED, false), a3.errorCategory = C2.DRM, a3.muxCode = D2.ENCRYPTED_OUTPUT_RESTRICTED;
...
` : ""}${e2.err ? `error message: ${(c4 = e2.err) == null ? void 0 : c4.message}
` : ""}`), a3.data = e2, a3;
};
...
var b = (s3, a3, t3) => (N2(s3, a3, "access private method"), t3);
var B3 = () => {
  try {
    return "0.28.2";
  } catch {
...
var K2 = class extends CustomVideoElement {
  constructor() {
    ...
    d(this, M);
    d(this, c, "");
    o(this, p, Gr2()), this.nativeEl.addEventListener("muxmetadata", (t3) => {
      var l3;
      let i2 = Xr2(this.nativeEl), r12 = (l3 = this.metadata) != null ? l3 : {};
  ...
  get playerSoftwareVersion() {
    var t3;
    return (t3 = n(this, I2)) != null ? t3 : v2;
  }
  ...
  get _hls() {
    var t3;
    return (t3 = n(this, E)) == null ? void 0 : t3.engine;
  }
  get mux() {
    var t3;
  ...
  get playbackToken() {
    ...
    if (this.hasAttribute(e.PLAYBACK_ID)) {
      let [, A3] = F2((i2 = this.playbackId) != null ? i2 : "");
      return (r12 = new URLSearchParams(A3).get("token")) != null ? r12 : void 0;
    }
  ...
  get tokens() {
    ...
    return { ...n(this, _2), ...t3 != null ? { playback: t3 } : {}, ...i2 != null ? { drm: i2 } : {} };
  }
  set tokens(t3) {
    o(this, _2, t3 != null ? t3 : {});
  }
  get ended() {
  ...
  get liveEdgeStart() {
    ...
    if (this.hasAttribute(e.LIVE_EDGE_OFFSET)) {
      let { liveEdgeOffset: r12 } = this, l3 = (t3 = this.nativeEl.seekable.end(0)) != null ? t3 : 0, A3 = (i2 = this.nativeEl.seekable.start(0)) != null ? i2 : 0;
      return Math.max(A3, l3 - r12);
    }
  ...
  set metadata(t3) {
    o(this, m, t3 != null ? t3 : {}), this.mux && this.mux.emit("hb", n(this, m));
  }
  get _hlsConfig() {
    return n(this, O3);
  }
  ...
  load() {
    o(this, E, Zr2(this, this.nativeEl, n(this, E)));
  }
  unload() {
    Kt2(this.nativeEl, n(this, E), this), o(this, E, void 0);
  }
  attributeChangedCallback(t3, i2, r12) {
    ...
    switch (CustomVideoElement.observedAttributes.includes(t3) && !["src", "autoplay", "preload"].includes(t3) && super.attributeChangedCallback(t3, i2, r12), t3) {
      ...
      case "src": {
        let u4 = !!i2, h3 = !!r12;
        !u4 && h3 ? b(this, f2, T).call(this) : u4 && !h3 ? this.unload() : u4 && h3 && (this.unload(), b(this, f2, T).call(this));
        break;
      }
      case "autoplay":
        if (r12 === i2) break;
        (A3 = n(this, E)) == null || A3.setAutoplay(this.autoplay);
        break;
      case "preload":
        if (r12 === i2) break;
        (L4 = n(this, E)) == null || L4.setPreload(r12);
        break;
      case e.PLAYBACK_ID:
        this.src = qr(this);
        break;
      ...
      case e.DISABLE_TRACKING: {
        if (r12 == null || r12 !== i2) {
          ...
          this.unload(), b(this, f2, T).call(this).then(() => {
      ...
      case e.DISABLE_COOKIES: {
        (r12 == null || r12 !== i2) && this.disableCookies && document.cookie.split(";").forEach((h3) => {
  ...
  connectedCallback() {
    var t3;
    (t3 = super.connectedCallback) == null || t3.call(this), this.nativeEl && this.src && !n(this, E) && b(this, f2, T).call(this);
  }
...
E = /* @__PURE__ */ new WeakMap(), g3 = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap(), _2 = /* @__PURE__ */ new WeakMap(), O3 = /* @__PURE__ */ new WeakMap(), I2 = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakMap(), f2 = /* @__PURE__ */ new WeakSet(), T = async function() {
  n(this, g3) || (await o(this, g3, Promise.resolve()), o(this, g3, null), this.load());
};
...
var u = (e2, o4, t3) => (g4(e2, o4, "read from private field"), t3 ? t3.call(e2) : o4.get(e2));
...
var d2 = (e2, o4, t3, l3) => (g4(e2, o4, "write to private field"), l3 ? l3.call(e2, t3) : o4.set(e2, t3), t3);
var s = class {
  addEventListener() {
  }
  removeEventListener() {
...
var y = { document: { createElement: C4 }, DocumentFragment, customElements: x3, CustomEvent: h, EventTarget: s, HTMLElement: n2, HTMLVideoElement: p2 };
var b2 = typeof window == "undefined" || typeof globalThis.customElements == "undefined";
var c2 = b2 ? y : globalThis;
var k = b2 ? y.document : globalThis.document;
var r9;
...
render_fn3 = function() {
  ...
  const sortedRates = Array.from(ratesSet).sort((a3, b4) => a3 - b4);
...
var E2 = (t3, a3, e2) => a3.has(t3) ? Je3("Cannot add the same private member more than once") : a3 instanceof WeakSet ? a3.add(t3) : a3.set(t3, e2);
...
var ot2 = (t3, { token: a3, customDomain: e2 = rt3, thumbnailTime: i2, programTime: r12 } = {}) => {
  var l3;
  let n3 = a3 == null ? i2 : void 0, { aud: d5 } = (l3 = ee2(a3)) != null ? l3 : {};
  if (!(a3 && d5 !== "t")) return `https://image.${e2}/${t3}/thumbnail.webp${ye3({ token: a3, time: n3, program_time: r12 })}`;
};
var nt3 = (t3, { token: a3, customDomain: e2 = rt3, programStartTime: i2, programEndTime: r12 } = {}) => {
  var d5;
  let { aud: n3 } = (d5 = ee2(a3)) != null ? d5 : {};
...
var ne3 = class {
  ...
  [Symbol.iterator]() {
    return u2(this, v3).values();
  }
  get length() {
    return u2(this, v3).length;
  }
  get value() {
    var a3;
    return (a3 = u2(this, v3).join(" ")) != null ? a3 : "";
  }
  set value(a3) {
    var e2;
  ...
  item(a3) {
    return u2(this, v3)[a3];
  }
  values() {
    return u2(this, v3).values();
  }
  keys() {
    return u2(this, v3).keys();
  }
  forEach(a3) {
    u2(this, v3).forEach(a3);
  }
  add(...a3) {
    var e2, i2;
    a3.forEach((r12) => {
      this.contains(r12) || u2(this, v3).push(r12);
    }), !(this.value === "" && !((e2 = u2(this, D4)) != null && e2.hasAttribute(`${u2(this, U3)}`))) && ((i2 = u2(this, D4)) == null || i2.setAttribute(`${u2(this, U3)}`, `${this.value}`));
  }
  remove(...a3) {
    var e2;
    a3.forEach((i2) => {
      u2(this, v3).splice(u2(this, v3).indexOf(i2), 1);
    }), (e2 = u2(this, D4)) == null || e2.setAttribute(`${u2(this, U3)}`, `${this.value}`);
  }
  contains(a3) {
    return u2(this, v3).includes(a3);
  }
  toggle(a3, e2) {
...
var Ae3 = class extends k2.HTMLElement {
  ...
  get defaultPlaybackRate() {
    var a3;
    return (a3 = y2(this.getAttribute(N3.PLAYBACKRATE))) != null ? a3 : 1;
  }
...
var la2 = (t3) => {
  var a3, e2, i2, r12, n3, d5, l3, b4, S2, Y4, _3, A3, R2, $3, h3, ie4, W3, Z2, Ie3, Pe4, De3, Ue3, Ve2, Be2, He3, Ke3, $e3, Fe3, Ye3, We2, Ze3, Ge3, je2, ze4, Xe3, qe2, Qe3;
  return Q3`
  <media-theme
    ...
    videotitle="${(A3 = t3.videoTitle) != null ? A3 : false}"
...
var Ne3 = class extends Ce3 {
  constructor() {
    ...
    E2(this, te3, {});
    E2(this, I3, true);
    E2(this, ae2, new ne3(this, "hotkeys"));
    E2(this, K3, { ...Mt3, onCloseErrorDialog: (e2) => {
      var r12;
  ...
  attributeChangedCallback(e2, i2, r12) {
    switch (p3(this, m3, w2).call(this), super.attributeChangedCallback(e2, i2, r12), e2) {
      ...
      case o2.THUMBNAIL_TOKEN: {
        if (r12) {
          let d5 = ee2(r12);
          if (d5) {
            let { aud: l3 } = d5, b4 = se2.THUMBNAIL;
            l3 !== b4 && x4(x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.").format({ aud: l3, expectedAud: b4, tokenNamePrefix: "thumbnail" }));
          }
        }
        break;
      }
      case o2.STORYBOARD_TOKEN: {
        if (r12) {
          let d5 = ee2(r12);
          if (d5) {
            let { aud: l3 } = d5, b4 = se2.STORYBOARD;
            l3 !== b4 && x4(x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.").format({ aud: l3, expectedAud: b4, tokenNamePrefix: "storyboard" }));
          }
        }
        break;
      }
      case o2.DRM_TOKEN: {
        if (r12) {
          let d5 = ee2(r12);
          if (d5) {
            let { aud: l3 } = d5, b4 = se2.DRM;
            l3 !== b4 && x4(x("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.").format({ aud: l3, expectedAud: b4, tokenNamePrefix: "drm" }));
          }
        }
        break;
      }
    ...
    [e.PLAYBACK_ID, M2.SRC, o2.PLAYBACK_TOKEN].includes(e2) && i2 !== r12 && C5(this, K3, { ...u2(this, K3), ...Mt3 }), p3(this, m3, H3).call(this, { [st3(e2)]: r12 });
  }
  ...
  get src() {
    var e2, i2;
    return this.playbackId ? (e2 = V3(this, M2.SRC)) != null ? e2 : void 0 : (i2 = this.getAttribute(M2.SRC)) != null ? i2 : void 0;
  }
  set src(e2) {
  ...
  addTextTrack(e2, i2, r12, n3) {
    ...
    if (d5) return ne2(d5, e2, i2, r12, n3);
  }
  removeTextTrack(e2) {
    var r12;
...
J3 = /* @__PURE__ */ new WeakMap(), ee3 = /* @__PURE__ */ new WeakMap(), te3 = /* @__PURE__ */ new WeakMap(), I3 = /* @__PURE__ */ new WeakMap(), ae2 = /* @__PURE__ */ new WeakMap(), K3 = /* @__PURE__ */ new WeakMap(), m3 = /* @__PURE__ */ new WeakSet(), w2 = function() {
  ...
  bt3(gt3(Ea2(this, { ...u2(this, K3), ...e2 })), this.shadowRoot);
}, wt3 = function() {
  let e2 = (r12) => {
    var l3, b4;
    ...
    d5 != null ? (l3 = this.mediaTheme) == null || l3.setAttribute(n3, d5) : (b4 = this.mediaTheme) == null || b4.removeAttribute(n3);
  };
  ...
  let e2 = (i2) => {
    ...
    if (!(r12 instanceof f)) {
      let { message: l3, code: b4 } = r12 != null ? r12 : {};
      r12 = new f(l3, b4);
    }
  ...
  let i2, r12 = /* @__PURE__ */ new WeakMap(), n3 = () => this.streamType === _.LIVE && !this.secondaryColor && this.offsetWidth >= 800, d5 = (_3, A3, R2 = false) => {
    if (n3()) return;
    Array.from(_3 && _3.activeCues || []).forEach((h3) => {
      if (!(!h3.snapToLines || h3.line < -5 || h3.line >= 0 && h3.line < 10)) if (!A3 || this.paused) {
...
`).length, W3 = -3;
    ...
    var _3, A3;
    d5(i2, (A3 = (_3 = this.mediaController) == null ? void 0 : _3.hasAttribute(Attributes.USER_INACTIVE)) != null ? A3 : false);
  }, b4 = () => {
    var R2, $3;
    let A3 = Array.from((($3 = (R2 = this.mediaController) == null ? void 0 : R2.media) == null ? void 0 : $3.textTracks) || []).filter((h3) => ["subtitles", "captions"].includes(h3.kind) && h3.mode === "showing")[0];
    A3 !== i2 && (i2 == null || i2.removeEventListener("cuechange", l3)), i2 = A3, i2 == null || i2.addEventListener("cuechange", l3), d5(i2, u2(this, I3));
  };
  b4(), (S2 = this.textTracks) == null || S2.addEventListener("change", b4), (Y4 = this.textTracks) == null || Y4.addEventListener("addtrack", b4), this.addEventListener("userinactivechange", () => {
    var A3, R2;
    let _3 = (R2 = (A3 = this.mediaController) == null ? void 0 : A3.hasAttribute(Attributes.USER_INACTIVE)) != null ? R2 : true;
    u2(this, I3) !== _3 && (C5(this, I3, _3), d5(i2, u2(this, I3)));
  });
};
function V3(t3, a3) {
  return t3.media ? t3.media.getAttribute(a3) : t3.getAttribute(a3);
...
var g6 = (e2, t3, n3) => (d3(e2, t3, "read from private field"), n3 ? n3.call(e2) : t3.get(e2));
...
var f4 = (e2, t3, n3, i2) => (d3(e2, t3, "write to private field"), i2 ? i2.call(e2, n3) : t3.set(e2, n3), n3);
var o3 = class {
  addEventListener() {
  }
  removeEventListener() {
...
var h2 = { document: { createElement: y3 }, DocumentFragment, customElements: b3, CustomEvent: m4, EventTarget: o3, HTMLElement: s2, HTMLVideoElement: a2 };
var E3 = typeof window == "undefined" || typeof globalThis.customElements == "undefined";
var l2 = E3 ? h2 : globalThis;
var x5 = E3 ? h2.document : globalThis.document;
l2.customElements.get("mux-player") || (l2.customElements.define("mux-player", Ci), l2.MuxPlayerElement = Ci);
...
var xe3 = (e2, t3) => {
  let { onAbort: n3, onCanPlay: o4, onCanPlayThrough: a3, onEmptied: l3, onLoadStart: i2, onLoadedData: c4, onLoadedMetadata: v4, onProgress: R2, onDurationChange: T3, onVolumeChange: h3, onRateChange: b4, onResize: C6, onWaiting: k3, onPlay: O4, onPlaying: S2, onTimeUpdate: w3, onPause: N4, onSeeking: L4, onSeeked: A3, onStalled: I4, onSuspend: _3, onEnded: K4, onError: H4, onCuePointChange: D5, onChapterChange: V4, metadata: W3, tokens: U4, paused: z3, playbackId: F4, playbackRates: G3, currentTime: Z2, themeProps: j4, extraSourceParams: q4, castCustomData: J4, _hlsConfig: Y4, ...$3 } = t3;
  return u3("tokens", U4, e2), u3("playbackId", F4, e2), u3("playbackRates", G3, e2), u3("metadata", W3, e2), u3("extraSourceParams", q4, e2), u3("_hlsConfig", Y4, e2), u3("themeProps", j4, e2), u3("castCustomData", J4, e2), u3("paused", z3, e2, (s3, y4) => {
  ...
  }), r11("abort", e2, n3), r11("canplay", e2, o4), r11("canplaythrough", e2, a3), r11("emptied", e2, l3), r11("loadstart", e2, i2), r11("loadeddata", e2, c4), r11("loadedmetadata", e2, v4), r11("progress", e2, R2), r11("durationchange", e2, T3), r11("volumechange", e2, h3), r11("ratechange", e2, b4), r11("resize", e2, C6), r11("waiting", e2, k3), r11("play", e2, O4), r11("playing", e2, S2), r11("timeupdate", e2, w3), r11("pause", e2, N4), r11("seeking", e2, L4), r11("seeked", e2, A3), r11("stalled", e2, I4), r11("suspend", e2, _3), r11("ended", e2, K4), r11("error", e2, H4), r11("cuepointchange", e2, D5), r11("chapterchange", e2, V4), [$3];
};
var de4 = g7();
var fe3 = "mux-player-react";
var ge4 = import_react.default.forwardRef((e2, t3) => {
  var i2;
  let n3 = (0, import_react.useRef)(null), o4 = f5(n3, t3), [a3] = xe3(n3, e2), [l3] = (0, import_react.useState)((i2 = e2.playerInitTime) != null ? i2 : Gr2());
  return import_react.default.createElement(Pe3, { ref: o4, defaultHiddenCaptions: e2.defaultHiddenCaptions, playerSoftwareName: fe3, playerSoftwareVersion: de4, playerInitTime: l3, ...a3 });
});
var ze3 = ge4;
export {
...
//# sourceMappingURL=dist-HZBOTPZG.js.map
